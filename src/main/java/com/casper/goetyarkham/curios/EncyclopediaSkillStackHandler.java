...
/**
 * The {@link CurioSlotIds#ENCYCLOPEDIA_SKILL} slot's own {@code
 ...
 * itself. See {@link com.casper.goetyarkham.mixin.EncyclopediaSkillSlotHandlerMixin}
 ...
 * slot identifier.
 */
public final class EncyclopediaSkillStackHandler extends DynamicStackHandler {
    public EncyclopediaSkillStackHandler(int size, Function<Integer, SlotContext> ctxBuilder) {

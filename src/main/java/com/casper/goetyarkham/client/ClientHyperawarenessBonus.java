...
import com.casper.goetyarkham.item.HyperawarenessBonusProvider;
 ...
 */
@OnlyIn(Dist.CLIENT)
public final class ClientHyperawarenessBonus {
    private ClientHyperawarenessBonus() {
    }
    ...
    public static ResourceSlotBonusSnapshot compute() {
        ...
        boolean equipped = HyperawarenessService.isWearing(player);
        ...
        return new ResourceSlotBonusSnapshot(
                true, equipped, HyperawarenessBonusProvider.INSTANCE.computeBonus(resourceContents));
    }
}

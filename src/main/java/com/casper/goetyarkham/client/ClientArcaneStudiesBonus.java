...
import com.casper.goetyarkham.item.ArcaneStudiesBonusProvider;
 ...
 */
@OnlyIn(Dist.CLIENT)
public final class ClientArcaneStudiesBonus {
    private ClientArcaneStudiesBonus() {
    }
    ...
    public static ResourceSlotBonusSnapshot compute() {
        ...
        boolean equipped = ArcaneStudiesService.isWearing(player);
        ...
        return new ResourceSlotBonusSnapshot(
                true, equipped, ArcaneStudiesBonusProvider.INSTANCE.computeBonus(resourceContents));
    }
}
